...
public class NetworkUtil {
    ...
    /**
     * Waits until a port is listening on a given host. An exception is thrown if the timeout is
     * excedeed.
     *
     * @param hostname Host name
     ...
     */
    public static void waitUntilPortListening(String hostname, int port, int timeout)
            throws IOException {
