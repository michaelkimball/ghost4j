...
public interface RemoteRenderer extends Renderer {
    ...
    /**
     * Renders pages of a given document an outputs result as a list of PageRaster objects (on image
     * per page).
     *
     * @param document Document to render. Document type may or may no be supported (support left to
     *     the render final implementation).
