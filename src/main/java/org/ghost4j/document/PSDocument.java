...
public class PSDocument extends AbstractDocument {
    ...
    /**
     * This methods appends pages the DSC way (only by relying on the structure). It does not work
     * with documents generated by different softwares / spools. It is intended to be used only for
     * rearranging pages of the same document. If you need to append a different document, consider
     * using the SafeAppenderModifier instead.
     *
    ...
    public void append(Document document) throws DocumentException {
        ...
        try {
            ...
            DSCComment pageOrTrailer = currentParser.nextDSCComment(DSCConstants.PAGE, gen);
