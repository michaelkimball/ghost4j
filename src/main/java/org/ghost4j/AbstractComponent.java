...
/**
 * Abstract component implementation. Contains methods that are common to the different component
 * types (converter, analyzer, modifier ...)
 *
...
public abstract class AbstractComponent implements Component {
    ...
    public Map<String, Object> extractSettings()
    ...
    protected synchronized boolean isDeviceSupported(String deviceName)
        ...
        if (AVAILABLE_DEVICE_NAMES.size() == 0) {
            ...
            try {
                ...
                String[] gsArgs = {"-dQUIET", "-dNOPAUSE", "-dBATCH", "-dNODISPLAY"};
     ...
     *
     * @param deviceName Device name
     * @throws GhostscriptException Thrown is device is not supported, or call to the interpreter
     *     fails
     */
