...
public class InkAnalyzerTest {
    ...
    /**
     * Test if the current Ghostscript version supports 'inkcov' device. If this device is not
     * supported, a warning message is issued
     */
    private boolean testInkCovDeviceSupport() throws Exception {
        ...
        if (!result) {
            System.out.println(
                    "WARNING : Ghostscript version does not support inkcov device, skipping InkAnalyzer test");
        }
